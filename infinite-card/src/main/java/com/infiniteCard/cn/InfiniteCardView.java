...
import cn.demo.com.infinite_card.R;
...
public class InfiniteCardView extends ViewGroup {
    ...
    public InfiniteCardView( Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InfiniteCardView( Context context,  AttributeSet attrs,  int defStyleAttr) {
