...
import com.infiniteCard.cn.transformer.DefaultCommonTransformer;
import com.infiniteCard.cn.transformer.DefaultTransformerAdd;
import com.infiniteCard.cn.transformer.DefaultTransformerRemove;
import com.infiniteCard.cn.transformer.DefaultTransformerToBack;
import com.infiniteCard.cn.transformer.DefaultTransformerToFront;
import com.infiniteCard.cn.transformer.DefaultZIndexTransformerCommon;
import com.infiniteCard.cn.transformer.DefaultZIndexTransformerToFront;
...
class CardAnimationHelper implements Animator.AnimatorListener,
    ...
    //for judge Z index
    //    private ArrayList<com.infiniteCard.cn.CardItem> mCards4JudgeZIndex;
    ...
    //custom animation com.infiniteCard.cn.transformer for card moving to front, card moving to back, and common card
    private AnimationTransformer mTransformerToFront, mTransformerToBack, mTransformerCommon;
    //custom animation com.infiniteCard.cn.transformer for card add and remove
    private AnimationTransformer mTransformerAnimAdd, mTransformerAnimRemove;
    //custom Z index com.infiniteCard.cn.transformer for card moving to front, card moving to back, and common card
     ...
     *
     * @param transformer          Z index com.infiniteCard.cn.transformer
...
//    @Override
//    public int compare(com.infiniteCard.cn.CardItem o1, com.infiniteCard.cn.CardItem o2) {
